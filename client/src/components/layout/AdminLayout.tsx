...
import { LayoutDashboard, Package, Tags, ShoppingCart, ArrowLeft, Users, FileText, Image, Ticket, LayoutGrid, Truck, FileBarChart, LayoutList, Tag } from "lucide-react";
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { icon: LayoutList, label: "Maestro Productos", path: "/admin/product-templates" },
